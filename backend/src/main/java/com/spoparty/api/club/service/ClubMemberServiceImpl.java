...
public class ClubMemberServiceImpl implements ClubMemberService {
	...
	@Transactional
	public ClubMemberResponseDTO createClubMember(PrincipalDetails principalDetails, InviteRequestDTO inviteRequestDto) {
	...
	public ClubMember getClubMemberById(Long clubMemberId) {
		return clubMemberRepository.findById(clubMemberId).orElseThrow(() -> new CustomException(CLUB_MEMBER_NOT_FOUND));
	}
